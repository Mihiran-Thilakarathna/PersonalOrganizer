...
constexpr auto qt_meta_stringdata_CLASSreportsENDCLASS = QtMocHelpers::stringData(
    "reports",
    "on_reportBackButton_clicked",
    ""
);
...
Q_CONSTINIT const QMetaObject reports::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSreportsENDCLASS_t,
        ...
        // method 'on_reportBackButton_clicked'
...
void reports::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_reportBackButton_clicked(); break;
        default: ;
        }
    }
    (void)_a;
